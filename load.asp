<%@  language="JAVASCRIPT" %>
<%
//if (Request.QueryString("R").Item != "19" && Request.QueryString("R").Item != "760070351")
//{
//Response.Redirect("http://mel.mapfre.cl/EnLinea/Control/disculpe.asp");
//}
/**/
...
//var MM_Cuenta = "774724206"; // RIPLEY
//var MM_Cuenta = "76213750K"; //CONOSUR -- HERTZ
//var MM_Cuenta = "78882050K" //WILLIS

//var MM_Cuenta = "886064004";
