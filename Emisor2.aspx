<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="Emisor2.aspx.cs" Inherits="Emisor2" Title="Emisión de Vehículos" %>
            ...
            <div id="DatosInspeccionEmisor">
                <fieldset>
                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                    ...
                                                    <td>
                                                        <table cellpadding="0" cellspacing="0" border="0">
                                                            <tr>
                                                                        ...
                                                                        <tr>
                                                                            <td class="fuenteDireccion3">
                                                                                Renato Sánchez 3597, Las Condes, Santiago.
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td class="fuenteDireccion2">
                        ...
                        <tr id="trInspeccionDomicilio" runat="server">
                            <td>
                        ...
                        <tr id="trRegistraInspeccion" runat="server">
                            <td>
                                <strong>
                        ...
                        <tr id="trInspeccionExpress" runat="server">
                            <td>
                                <asp:RadioButton ID="rdbInspeccionExpress" AutoPostBack="true" GroupName="rdbInspeccion"
                                    Text="Inspección Express" runat="server" OnCheckedChanged="rdbInspeccionExpress_CheckedChanged" />
                            </td>
                        </tr>
        ...
        <ContentTemplate>
            <div id="Botonera">
                <table id="tblBotonera" runat="server">
                    <tr>
                        <td align="left">
                            <asp:ImageButton ID="ImgNuevaCotizacion" runat="server" SkinID="ImgNuevaCotizacion"
                                OnClick="ImgNuevaCotizacion_Click" />
                        </td>
                        <td>
                            <asp:ImageButton ID="ImgValidaEmitir" SkinID="ImgEmitir" runat="server" OnClick="ImgValidaEmitir_Click"
                                OnClientClick="javascript:if (!confirm('¿Esta seguro de emitir la poliza para el plan seleccionado?')) return false;" />                             
                            <asp:UpdateProgress ID="UpdateProgress1" runat="server" AssociatedUpdatePanelID="UpdatePanel3">
                                <ProgressTemplate>
                                    ...
                                    <div class="emitimg">
                                        Por favor, Espere mientras emitimos su póliza
                                    </div>
                                    </div>
                                </ProgressTemplate>
                            </asp:UpdateProgress>
