...
/// <summary>
/// Class that enables the creation of expressions containing the current theme or stylesheet theme as set in the 
/// <c>pages</c> section of the web.config.
/// </summary>
/// <remarks>
/// <para>The following two types of expressions are supported:
///	1. <c>&lt;%$ Themes:StylesheetTheme %&gt;</c> or
/// 2. <c>&lt;%$ Themes:StylesheetTheme(&lt;some format string&gt;) %&gt;</c>, where <c>&lt;some format string&gt;</c>
/// can contain one placeholder, such as '~/App_Themes/{0}/Images/someimage.gif'.</para>
/// 
